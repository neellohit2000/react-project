...
export default function Profile() {
    ...
    const [showListingsError, setShowListingsError] = useState(false); // Moved here
    const [userListings, setUserListings] = useState([]); // Moved here
    ...
    return (
        <div className="p-3 max-w mx-auto">
            ...
            <p className='text-green-700 mt-5'>{updateUserSuccess?'success':''}</p>
